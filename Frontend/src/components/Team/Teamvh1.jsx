  ...
  return (
    <div className="relative min-h-screen p-4 md:p-8 overflow-hidden">
      ...
      <div className="relative w-full h-full">
        <h1
          className="absolute font-['Protest_Riot'] font-semibold text-white leading-[60px] text-[40px] sm:text-[60px] md:text-[80px] left-[3vw] top-[12vh]
        "
        >
          "MEET
        </h1>
        ...
        <motion.div
          ...
          whileHover={{
            ...
            scale: 1.1,
            boxShadow:
              "0 8px 40px rgba(255, 107, 53, 0.4), 0 0 60px rgba(243, 74, 130, 0.3), 0 0 80px rgba(240, 160, 31, 0.2)",
          }}
          transition={{
            duration: 2.2,
            repeat: Infinity,
