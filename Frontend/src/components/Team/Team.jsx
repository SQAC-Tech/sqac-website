  ...
  const grouped = useMemo(() => {
    ...
    filtered.forEach((m) => {
      ...
      if (domain.toLowerCase() === "board member") {
        if (p.includes("secretary") && !p.includes("joint"))
          g.Secretary.push(m);
        else if (p.includes("joint")) g["Joint Secretary"].push(m);
        else if (p.includes("technical"))
          g.Leads.push({ ...m, position: "Technical Lead" });
        else if (p.includes("corporate"))
          g.Leads.push({ ...m, position: "Corporate Lead" });
        return;
      }
              ...
              <div key={i} className="relative mb-20">
                ...
                <div className="flex justify-center mt-20">
                  ...
                  >
                    ...
                    {members.map((m, idx) => {
                      const cardBase =
                        "group w-[18rem] min-h-[18rem] p-5 rounded-2xl transition-all relative overflow-hidden";
                      ...
                      const innerStyle = !isDarkMode
                        ? {
                            ...
                            backgroundImage:
                              "linear-gradient(180deg, rgba(255,255,255,0.9), rgba(250,250,250,0.98)), repeating-linear-gradient(135deg, rgba(0,0,0,0.015) 0 2px, transparent 2px 8px)",
                          }
                        : {};
                      return (
                        <div
                          ...
                          className={`${
                            !isDarkMode
                              ? "p-[1px] rounded-2xl bg-gradient-to-r from-orange-300/50 via-yellow-200/30 to-transparent"
                              : ""
                          }`}
                        >
                          <motion.article
                            ...
                            whileHover={{
                              ...
                              y: -10,
                              boxShadow:
                                "0 28px 90px rgba(249,115,22,0.22), 0 0 80px rgba(249,115,22,0.12)",
                            }}
                          ...
                          >
                            ...
                            {!isDarkMode && (
                              <>
                                <div
                                  className="absolute left-0 top-0 h-full w-1 rounded-l-2xl transition-all duration-300 group-hover:blur-sm"
                                  style={{
                                    background:
                                      "linear-gradient(180deg,#ffd3a5,#ff9a5a)",
                                    boxShadow: "0 0 18px rgba(255,160,60,0.12)",
                                  }}
                                />
                                <div
                                  className="absolute right-0 top-0 h-full w-1 rounded-r-2xl transition-all duration-300 group-hover:blur-sm"
                                  style={{
                                    background:
                                      "linear-gradient(180deg,#ffd3f0,#ffd3a5)",
                                    boxShadow:
                                      "0 0 18px rgba(255,160,120,0.06)",
                                  }}
                                />
                                {/* corner highlight shapes */}
                                <div
                                  className="absolute -top-3 -left-3 w-6 h-6 rotate-45"
                                  style={{
                                    background:
                                      "linear-gradient(135deg,#fff6e6,#ffd3a5)",
                                    boxShadow:
                                      "0 6px 18px rgba(255,200,140,0.12)",
                                  }}
                                />
                                <div
                                  className="absolute -bottom-3 -right-3 w-6 h-6 -rotate-12"
                                  style={{
                                    background:
                                      "linear-gradient(135deg,#ffd3f0,#ffe7a8)",
                                    boxShadow:
                                      "0 6px 18px rgba(255,150,200,0.06)",
                                  }}
                                />
                                {/* subtle top shimmer line - reduced to avoid double top-line */}
                                <div
                                  className="absolute top-3 left-8 right-8 h-px rounded-full opacity-40 pointer-events-none"
                                  style={{
                                    background:
                                      "linear-gradient(90deg, rgba(255,211,165,0.18), rgba(255,231,168,0.12), rgba(255,211,240,0.14))",
                                  }}
                                />
                            ...
                            {!isDarkMode && (
                              <div
                                ...
                                style={{
                                  background:
                                    "linear-gradient(90deg,#ffd3a5,#ff9a5a,#ffd3f0)",
                                  boxShadow: "0 6px 20px rgba(255,140,40,0.08)",
                                }}
                              />
                            )}
                            <div
                              className={`flex justify-center gap-3 mb-3 transition-all ${
                                isDarkMode
                                  ? "opacity-0 group-hover:opacity-100 -translate-y-3 group-hover:-translate-y-6"
                                  : "opacity-0 group-hover:opacity-100 -translate-y-1 group-hover:-translate-y-3"
                              }`}
                            >
                              {techIcons.map(({ Icon, color }, i) => (
                                <span
                                  ...
                                  className={`flex items-center justify-center w-8 h-8 rounded-full ${
                                    !isDarkMode
                                      ? "bg-white/90 border border-white/60 shadow-sm"
                                      : ""
                                  }`}
                                >
                            ...
                            <div
                              className={`mx-auto mb-3 w-36 h-36 ${
                                !isDarkMode
                                  ? "relative p-1 rounded-full bg-gradient-to-br from-orange-50 to-white shadow-lg"
                            ...
                            >
                              <motion.div
                                whileHover={{
                                  scale: 1.08,
                                  boxShadow:
                                    "0 22px 70px rgba(249,115,22,0.16), 0 0 48px rgba(249,115,22,0.08)",
                                }}
                              ...
                              {!isDarkMode && (
                                <div
                                  ...
                                  style={{
                                    boxShadow:
                                      "inset 0 0 0 4px rgba(255,160,60,0.14), 0 8px 30px rgba(255,140,40,0.06)",
                                  }}
                                />
                              )}
                            </div>
                            <h4
                              className={`text-lg text-center font-semibold ${
                                isDarkMode
                                  ? "text-white"
                                  : "bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-pink-500"
                              }`}
                            >
                              {m.name}
                            </h4>
                            ...
                            {isDarkMode ? (
                              ...
                              <div className="flex justify-center mt-2">
                                <span className="text-xs px-3 py-1 rounded-full bg-orange-50 text-orange-600 font-medium shadow-sm">
                                  {m.position}
                                </span>
                              </div>
                            )}
                            <div
                              className={`flex justify-center gap-4 mt-3 text-lg ${
                            ...
                            >
                              {m.linkdln && (
                                <a
                                  ...
                                  className={
                                    !isDarkMode
                                      ? "inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-sky-100 to-sky-50 text-sky-600 hover:from-sky-200 hover:to-sky-100 shadow-md transition-all"
                                      : "text-white"
                                  }
                                >
                                  <FaLinkedin
                                    style={
                                      isDarkMode ? { color: "#0ea5e9" } : {}
                                    }
                                  />
                                </a>
                              )}
                              {m.github && (
                                <a
                                  ...
                                  className={
                                    !isDarkMode
                                      ? "inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-slate-100 to-slate-50 text-slate-800 hover:from-slate-200 hover:to-slate-100 shadow-md transition-all"
                                      : "text-white"
                                  }
                                >
                              ...
                              {m.insta && (
                                <a
                                  ...
                                  className={
                                    !isDarkMode
                                      ? "inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-pink-100 to-pink-50 text-pink-500 hover:from-pink-200 hover:to-pink-100 shadow-md transition-all"
                                      : "text-white"
                                  }
                                >
                                  <FaInstagram
                                    style={
                                      isDarkMode ? { color: "#f973a4" } : {}
                                    }
                                  />
                                </a>
                              )}
