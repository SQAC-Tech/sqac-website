...
const Events = () => {
  ...
  const events = [
    {
      ...
      bgColor: "from-[#b6f0ff] via-[#dcb6ff] to-cyan-200",
  ...
  return (
    <motion.div
      className="min-h-screen flex flex-col items-center justify-center px-4 py-10 relative overflow-hidden bg-gradient-to-t from-cyan-200 via-purple-200 to-violet-300 dark:from-zinc-800 dark:via-zinc-900 dark:to-zinc-950 text-gray-800 dark:text-white"
      style={{
    ...
    >
      ...
      {[...Array(8)].map((_, i) => (
        <motion.div
          key={i}
          className="absolute w-2 h-2 rounded-full opacity-30 bg-white dark:bg-orange-300"
      ...
      <motion.div
        className="absolute top-10 left-10 w-32 h-32 rounded-full opacity-20 blur-xl bg-white dark:bg-orange-400"
        variants={itemVariants}
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, 180, 360],
      ...
      />
      <motion.div
        className="absolute bottom-20 right-20 w-40 h-40 rounded-full opacity-20 blur-2xl bg-white dark:bg-orange-500"
        variants={itemVariants}
        animate={{
          scale: [1, 1.3, 1],
          rotate: [360, 180, 0],
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/4 w-24 h-24 rounded-full opacity-15 blur-lg bg-white dark:bg-orange-300"
        variants={itemVariants}
        animate={{
          scale: [1, 1.4, 1],
          x: [0, 50, 0],
        ...
        {phase === "start" ? (
          ...
          >
            {isDarkMode ? (
              ...
              <motion.div
                className="w-full h-full rounded-lg shadow-2xl border-4 bg-transparent border-gray-300 relative overflow-hidden"
                whileHover={{ scale: 1.02 }}
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
              >
                {/* Journey Design */}
          ...
          >
            ...
            <motion.button
              ...
              className={`absolute -top-16 right-0 z-20 px-4 py-2 text-white rounded-full transition-all duration-300 flex items-center space-x-2 ${
                isDarkMode
                  ? "bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 shadow-[0_4px_15px_rgba(255,165,0,0.3)]"
                  : "bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 shadow-[0_4px_15px_rgba(147,51,234,0.3)]"
              }`}
            ...
            <div className="relative flex justify-center items-center">
              <AnimatePresence mode="wait" key={`slides-${isDarkMode}`}>
                {isDarkMode ? (
                  <div
                    className={`
    relative w-full max-w-4xl h-[500px] p-1 rounded-2xl
    ${
      isDarkMode
        ? "bg-gradient-to-r from-orange-400 via-pink-500 to-purple-600"
        : "bg-gradient-to-b from-[#b6f0ff] via-[#dcb6ff] to-cyan-200"
    }
  `}
                  >
                    <motion.div
                      ...
                      className="relative w-full h-full bg-gradient-to-br from-black/70 to-black/50 backdrop-blur-md rounded-2xl shadow-2xl border border-orange-500 overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.3),inset_0_0_50px_rgba(255,255,255,0.05)]"
                    >
                      {/* Slide Background */}
                  ...
                  <div
                    className={`relative w-full max-w-4xl h-[500px] p-1 rounded-2xl bg-gradient-to-b from-[#b6f0ff] via-[#dcb6ff] to-cyan-200`}
                  >
                    <motion.div
                      key={currentSlide}
                      initial={{ opacity: 0, x: 300, scale: 0.8 }}
                      ...
                      className="relative w-full h-full bg-gradient-to-br from-white/70 to-white/50 backdrop-blur-md rounded-2xl shadow-2xl border border-pink-200/30 overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.3),inset_0_0_50px_rgba(255,255,255,0.05)]"
                    >
                      {/* Slide Background */}
                      <div className="absolute inset-0">
                        <img
            ...
            <motion.button
              ...
              className={`absolute left-4 top-1/2 transform -translate-y-1/2 z-30 p-4 text-white rounded-full transition-all duration-300 ${
                currentSlide === 0 ? "opacity-50 cursor-not-allowed" : ""
              } ${
                isDarkMode
                  ? "bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 disabled:from-gray-400 disabled:to-gray-500 shadow-[0_4px_15px_rgba(255,165,0,0.3)]"
                  : "bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 disabled:from-gray-400 disabled:to-gray-500 shadow-[0_4px_15px_rgba(147,51,234,0.3)]"
              }`}
