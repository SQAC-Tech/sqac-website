...
function Content() {
  ...
  return (
    <div className="pt-[120vh] sm:pt-[110vh] md:pt-[100vh] lg:pt-0 min-h-screen bg-gradient-to-t from-orange-300 via-neutral-50 to-pink-300 overflow-hidden relative">
