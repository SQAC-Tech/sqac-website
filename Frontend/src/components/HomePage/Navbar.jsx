    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-dark-primary/80 backdrop-blur-lg shadow-md border-b border-gray-700 px-4 sm:px-8 py-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full bg-gradient-to-r from-accent to-accentSecondary/20 hover:from-accent/30 hover:to-accentSecondary/30 transition-all duration-300 hover:scale-110"
