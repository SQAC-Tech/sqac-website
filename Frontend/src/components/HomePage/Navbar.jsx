...
function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-lg shadow-md border-b px-4 sm:px-8 py-3 ${
        isDarkMode
          ? "bg-gradient-to-r from-black via-gray-900 to-black border-gray-700"
          : "bg-gradient-to-r from-pink-50 via-purple-50 to-cyan-50 border-pink-200"
      }`}
    >
        ...
        <div className="sm:hidden mt-4 px-4 py-4 bg-dark-surface/90 backdrop-blur-md rounded-xl shadow-xl space-y-3 text-base font-medium transition-all duration-500 animate-fade-in-down">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`p-2 rounded-full bg-gradient-to-r from-accent to-accentSecondary/20 hover:from-accent/30 hover:to-accentSecondary/30 transition-all duration-300 flex items-center gap-2 ${
